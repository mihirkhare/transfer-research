...
static void PragmaTransferNone(ClientContext &context, const FunctionParameters &parameters) {
...
static void PragmaTransferRPTPlus(ClientContext &context, const FunctionParameters &parameters) {
